...
ActiveRecord::Schema.define(version: 20170220144382) do
  ...
  add_index "spree_affiliate_commission_rules", ["active"], name: "index_spree_affiliate_commission_rules_on_active"
  add_index "spree_affiliate_commission_rules", ["affiliate_id"], name: "index_spree_affiliate_commission_rules_on_affiliate_id"
  add_index "spree_affiliate_commission_rules", ["commission_rule_id"], name: "index_spree_affiliate_commission_rules_on_commission_rule_id"
  ...
  add_index "spree_affiliates", ["active"], name: "index_spree_affiliates_on_active"
  add_index "spree_affiliates", ["email"], name: "index_spree_affiliates_on_email"
  ...
  add_index "spree_commission_transactions", ["affiliate_id"], name: "index_spree_commission_transactions_on_affiliate_id"
  add_index "spree_commission_transactions", ["commission_id"], name: "index_spree_commission_transactions_on_commission_id"
  ...
  add_index "spree_commissions", ["affiliate_id"], name: "index_spree_commissions_on_affiliate_id"
  add_index "spree_commissions", ["end_date"], name: "index_spree_commissions_on_end_date"
  add_index "spree_commissions", ["start_date"], name: "index_spree_commissions_on_start_date"
  ...
  add_index "spree_orders", ["affiliate_id"], name: "index_spree_orders_on_affiliate_id"
